...
### 5) `read_air_fares()`:
The data covers air fares of all domestic flights.

- [Data dictionary for air fares data](https://www.anac.gov.br/acesso-a-informacao/dados-abertos/areas-de-atuacao/voos-e-operacoes-aereas/tarifas-aereas-domesticas/46-tarifas-aereas-domesticas).
...
```{r, eval=FALSE}
air_fares <- flightsbr::read_air_fares(date=202003)
