...
### 5) `read_airfares()`:
The data covers air fares of domestic and international flights.

- [Data dictionary for domestic airfares data](https://www.anac.gov.br/acesso-a-informacao/dados-abertos/areas-de-atuacao/voos-e-operacoes-aereas/tarifas-aereas-domesticas/46-tarifas-aereas-domesticas).
- [Data dictionary for international airfares data](https://www.gov.br/anac/pt-br/assuntos/dados-e-estatisticas/microdados-de-tarifas-aereas-comercializadas).
